package DoitAlgorithm.Practice.chap04.Q1;

import DoitAlgorithm.Complete.chap04.IntStack;
...
public class IntStackTesterEx {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.print("(1) 푸시  (2) 팝  (3)피크" + "(4) 덤프  (5) 검색  (6)비움" + "(7) 출력  (8) 종료 : ");
            ...
            switch (menu){
                ...
                case 7 :
                    ...
                    System.out.println("가득 " + (s.ifFull() ? "차 있습니다." : "차 있지 않습니다."));
                    break;
            }
        }
    }
